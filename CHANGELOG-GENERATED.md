...
- **#25**: Missing Tool Result Block for Tool Use ID toolu_01GUUUdR6TqtrqKTprMSuLqc (duplicate)
- **#21**: Invalid JSON Encoding Error During API Request (duplicate)

### 📊 Statistics
- Total closed issues analyzed: 14
- Platform label distribution:
  - platform:macos — 7
- Area label distribution:
  - area:tools — 3
  - area:core — 4
  - area:api — 3
  - area:tui — 3
